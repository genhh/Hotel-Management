...
DROP DATABASE IF EXISTS hotel_storage;
CREATE DATABASE hotel_storage;
USE hotel_storage;
...
DROP DATABASE IF EXISTS hotel_account;
CREATE DATABASE hotel_account;
USE hotel_account;
...
-- 点赞业务的数据库初始化
DROP DATABASE IF EXISTS hotel_praise;
CREATE DATABASE hotel_praise;
USE hotel_praise;
CREATE TABLE `item`
(
    `id`          bigint(11) unsigned NOT NULL AUTO_INCREMENT,
